...
public class FlooringMasteryTaxDaoFileImpl implements FlooringMasteryTaxDao {
      ...
      private final String TAX_LIST_FILE;
    
    public FlooringMasteryTaxDaoFileImpl() {
        TAX_LIST_FILE = "SampleFileData/Data/Taxes.txt";
    }

    public FlooringMasteryTaxDaoFileImpl(String taxListTextFile) {
        TAX_LIST_FILE = taxListTextFile;
    }
