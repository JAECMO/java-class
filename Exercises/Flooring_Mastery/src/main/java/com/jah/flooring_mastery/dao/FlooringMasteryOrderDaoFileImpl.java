...
public class FlooringMasteryOrderDaoFileImpl implements FlooringMasteryOrderDao {
    ...
    private final String BACKUP_FILE_FOLDER;

    public FlooringMasteryOrderDaoFileImpl() {
        ORDER_FILES_FOLDER = "SampleFileData/Orders/";
        BACKUP_FILE_FOLDER = "SampleFileData/Backup/";
    }

    public FlooringMasteryOrderDaoFileImpl(String pathFolderOrder, String pathFileBackUp) {
        ORDER_FILES_FOLDER = pathFolderOrder;
        BACKUP_FILE_FOLDER= pathFileBackUp;
    }
    ...
    public String getExportLink() {
        return BACKUP_FILE_FOLDER+"DataExport.txt";
    }

    @Override
    public String checkOrderFolderPath() {
        String folderPath = new FlooringMasteryOrderDaoFileImpl().ORDER_FILES_FOLDER;
        return folderPath;
    }
    
    @Override
    public String checkBackupFolderPath() {
        String folderPath = new FlooringMasteryOrderDaoFileImpl().BACKUP_FILE_FOLDER;
        return folderPath;
    }
    ...
    private void writeOrdersList(LocalDate date) throws FlooringMasteryPersistenceException, FlooringMasteryFileCreationException {
        ...
        String filePath = ORDER_FILES_FOLDER + "Orders_" + formattedDate + ".txt";
    ...
    private void writeAllOrdersList(List<Order> orderList) throws FlooringMasteryPersistenceException, FlooringMasteryFileCreationException {
        ...
        String filePath = BACKUP_FILE_FOLDER+"DataExport.txt";
