...
import static com.jah.flooring_mastery.dao.FlooringMasteryTaxDaoFileImpl.DELIMITER;
...
public class FlooringMasteryProductDaoFileImpl implements FlooringMasteryProductDao  {
    ...
    private final String PRODUCT_LIST_FILE;
    
    public FlooringMasteryProductDaoFileImpl() {
        PRODUCT_LIST_FILE = "SampleFileData/Data/Products.txt";
    }

    public FlooringMasteryProductDaoFileImpl(String productListTextFile) {
        PRODUCT_LIST_FILE = productListTextFile;
    }
    ...
    private void loadProductList() throws FlooringMasteryPersistenceException {
        ...
        try {
            ...
            scanner = new Scanner(
                    new BufferedReader(
                            new FileReader(PRODUCT_LIST_FILE)));
