...
public class UserIOConsoleImpl implements UserIO {
    ...
    public String readMpaaRating(String prompt) {
        ...
        String choice = this.readString(prompt).toUpperCase();
        ...
        while (keepGoing) {
            ...
            switch (choice) {
                ...
                case "NC-17":
                    ...
                    break;
                default:
                    prompt = "Invalid MPAA rating. Please choose between: G,PG,PG-13,R,NC-17";
                    choice = this.readString(prompt).toUpperCase();
            }
